...
public class FeedService {
     ...
     * @return
     */
    public CreateFeedResponseDto createFeed(String group_name, UserDetailsImpl userDetails, MultipartFile file, CreateFeedRequestDto requestDto) {
        ...
        //url 의 group_name 과 loginUser 의 소속 group 명 이 동일한지 확인
        checkArtistGroup(loginUser.getArtist().getArtistGroup().getGroupName(), group_name);
...
//        Feed newFeed = new Feed.of(requestDto, loginUser, group_name, filePath);
    ...
    public UpdateFeedResponseDto updateFeed(String group_name, Long artistFeedId, UserDetailsImpl userDetails, MultipartFile file, UpdateFeedRequestDto requestDto) {
        ...
        //feed 가 작성된 그룹과 입력받은 그룹 이름이 같은지 확인
...
//        Feed updatedFeed = foundFeed.updateFeed(requestDto, filePath);
    ...
    public FeedResponseDto getFeed(String groupName, Long artistFeedId, UserDetailsImpl userDetails) {
        ...
        //찾는 feed 가 작성된 그룹과 입력받은 그룹 이름이 같은지 확인
    ...
    //Feed 다건 조회(페이지)
    public FeedResponseDto getAllFeed(String groupName, UserDetailsImpl userDetails) {
        return null;
    }
...
//        loginUser.getArtist().getArtistGroup().getGroupName()
        ...
        // 즉, 로그인유저가 '작성자 본인'이거나 '작성자의 엔터테인먼트를 가진 유저'인 경우
